...
datasets=['./offline-test.pkl', './test_caption.txt']
...
for epoch in range(5):
    ...
    for step,(x,y) in tqdm(enumerate(train_loader)):
        ...
        attention_sum_init = torch.zeros(batch_size,1,dense_input,output_area)
        decoder_attention_init = torch.zeros(batch_size,1,dense_input,output_area)
